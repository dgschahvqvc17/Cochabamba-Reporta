/**
 * Componente compartido: Iconos vectoriales (MVC - componentes).
 *
 * Conjunto mínimo de iconos SVG (Material Design, Apache 2.0) renderizados
 * con react-native-svg. Funcionan en web (react-native-web) y en móvil.
 * Reemplazan el uso de emojis en toda la interfaz.
 *
 * @format
 */
