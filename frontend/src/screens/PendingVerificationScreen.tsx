...
import { loadPendingVerification } from '../controllers/incidentController';
...
function PendingVerificationScreen({
  ...
  const load = useCallback(
    async (targetPage: number, refreshing = false) => {
      ...
      const result = await loadPendingVerification({
        page: targetPage,
        limit: PAGE_SIZE,
                ...
                >
                  ...
                  <View style={styles.cardFoot}>
                    <View style={styles.footLink}>
                      <Icon name="person" size={14} color={Colors.accent} />
                      <Text style={styles.footLinkText}>Asignar a verificación</Text>
                    </View>
